...
act as the initial null hypothesis. 
...
%\notesbox{Note:  These are the section headings that I decided to use from
%Chapter ~\ref{ch:GraphTheory}. Check out several recent theses to decide how
%you want to lay out your introduction (and conclusion) chapters.}
%