...
\begin{abstract}
  ...
  the 2019 Canadian Federal Election, this paper develops two novel, graph-based
  metrics of topic centrality  -- one which measures how central a topic was to
  the general discourse, and one which measures how central a topic was to a
  particular voting bloc. Statistically significant variations in topic
